...
class GTSController extends Controller
{
    public function update (Request $request, $id) {
        ...
        $data = $this->validate($request, [
	        ...
	        'academic_awards_received' 		        => 'required',
            'other_awards'		                    => 'required',
            'professional_examinations_passed'	    => 'required',
            // Educational Background (Further Studies)
            'program_pursued'		                => 'required',
            'name_of_graduate_school'	            => 'required',
            'address_of_graduate_school'	        => 'required',
            'advance_studies'                       => 'required',
            'is_presently_employed'                 => 'required',
            //Employment Data (Status: Employed)
            'industry_currently_working'            => 'required',
            'job_level'                             => 'required',
            'present_job_position'                  => 'required',
            'job_not_related_to_degree'             => 'required',
            'months_employed'                       => 'required',
            'name_of_company'                       => 'required',
            'address_of_company'                    => 'required',
            //YES
            ...
            //Reason No
            'reasonsNo'                             => 'required',
            'isFirstJobRelated'                     => 'required',
            'isJobpositionFirstworkAfterCollege'    => 'required',
            
            //extends
            'monthsEmployedfirstjobAfterGraduate'   => 'required',
            'jobRolesExperienced'                   => 'required',
            'conceptsLearned'                       => 'required',
