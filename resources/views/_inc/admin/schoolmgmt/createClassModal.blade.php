...
<div class="row">
    <div class="col-md-6 form-group">
        ...
        <select required class="form-control input-rounded text-center" name="teacher_id">
    ...
    <div class="col-md-6 form-group">
        ...
        <select required class="form-control input-rounded text-center" name="subject_id">
...
<div class="row">
    <div class="col-md-6 form-group">
        ...
        <select required class="form-control input-rounded text-center" name="semester_id">
    ...
    <div class="col-md-6 form-group">
        ...
        {{Form::select('day', ['Monday' => 'Monday', 'Tuesday' => 'Tuesday', 'Wednesday' => 'Wednesday', 
                              ...
                              ['class' => 'form-control input-rounded', 'placeholder' => 'Choose Day', 'required'])}}
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 form-group">
        ...
        {{Form::select('class_start', ['6:00' => '6:00', '7:30' => '7:30', '9:00' => '9:00', 
                                        ...
                                        ['class' => 'form-control input-rounded', 'placeholder' => 'Choose', 'required'])}}
    </div>
