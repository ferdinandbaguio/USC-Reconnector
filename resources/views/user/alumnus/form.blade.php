...
<div class="container-fluid p-0 mb-4">
	...
	<div class="row" id="aboutUnderProgram">
	<div class="col-12 col-md-6 p-4 mx-auto bg-light rounded">
...
<!-- <div class="container-fluid p-0" id="employedNow" style="display: none;"> -->
 ...
 -->
	...
	<!-- GENERAL INFORMATION ROW END -->

	<!-- <div class="row" id="enData"> -->
		<!-- Employment Data ROW -->
		<!-- <div class="col-12 col-md-6 p-4 mx-auto bg-light rounded">
	...
	<!-- Employment Data ROW END -->


	<!-- <div class="row" id="enUnderGrad"> -->
	...
	<!-- Undergraduate Program Details END -->
