...
<div class="ibox">
    <div class="ibox-head">
        <div class="ibox-title text-info">
            Number of Admins:<b><i> @if(isset($users)){{$users->count()}}@endif</i></b>
        </div>
        <span data-toggle="modal" data-target="#create" data-type="Admin">
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Showing Admin</h4>
    </div>
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Creating New Admin</h4>
    </div>
...
<div class="modal-content">
    ...
    <div class="modal-header">
        ...
        {{ Form::file('picture') }}
        <h4 class="modal-title" id="myModalLabel">Editing Admin</h4>
    </div>
    <div class="modal-body">
...
<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title text-center" id="myModalLabel">Delete Admin Confirmation</h4>
    </div>
